<?php
/**
 * Lermars functions and definitions
 *
 ...
 */
function lermars_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Lermars, use a find and replace
		* to change 'lermars' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'lermars', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'lermars' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'lermars_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'lermars_setup' );
 ...
 */
function lermars_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'lermars_content_width', 640 );
}
add_action( 'after_setup_theme', 'lermars_content_width', 0 );
 ...
 */
function lermars_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'lermars' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'lermars' ),
...
add_action( 'widgets_init', 'lermars_widgets_init' );
...
function lermars_scripts() {
	wp_enqueue_style( 'lermars-style', get_stylesheet_uri(), array(), _S_VERSION );
	...
	wp_register_script( 'mainsingle-script', get_template_directory_uri() . '/assets/js/main-single.js', array(), null, true );

    wp_enqueue_script( 'mainsingle-script' );

	wp_register_script( 'main-script', get_template_directory_uri() . '/assets/js/main.js', array(), null, true );

    wp_enqueue_script( 'main-script' );

	wp_enqueue_script( 'lermars-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
